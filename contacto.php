     ...
     <section class="cont">
			<div class="container-ms padd-90">
				<div class="col-md-6  wow fadeInLeft">
					<h2 style="padding-top:0; margin-top: -5px;">conversemos</h2>
					<p>Queremos ofrecerte el mejor proyecto para ti. Cuéntanos qué estas buscando.</p><br><a href="https://gquest.tgapps.net/inmobiliaria/103-68-0-4-0-0-30-1 " class="btn-w btn-primary btn-lg btn-nm" style="float:initial;" target="_blank">Cuéntanos ></a><br><br>
