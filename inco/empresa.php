...
<head>
	<meta charset="UTF-8">
	<title>Inmobiliaria Inco - Empresa</title>
...
<section class="cont text-center padd">
 <div class="title-center">
	<h1 class="text-back wow fadeInUp"><strong>Desarrollos </strong><br>de excelencia</h1>
...
<video id="v1" class="videoifm hidden-sm hidden-xs" width="100%" height="" autoplay="" loop=""><source src="img/video/empresa.mp4" type="video/mp4"></video>
</div>
<div id="bajar"></div>
<section class="text-cont">
	...
	<br><a href="en-venta.php" class="btn-w">Ver proyectos ></a>
	</div>
