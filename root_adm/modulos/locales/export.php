...
header("content-disposition: attachment;filename=Contacto - Proyecto Locales Comerciales.xls");
    ...
    <table id="tabla" style="width:100%;"> 
        <tr>
            <td align="center" colspan="10" style="width:100%;">
                <h1>LOCALES COMERCIALES - Mensajes de Contacto</h1>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="10" style="width:100%;">
...
<?php
    $data   = Datos("contacto","proyecto = 'locales' order by id DESC","*");
    
    if(Filas("contacto","proyecto = 'locales' order by id DESC") > 0)
    {
        ...
        <table id="tabla" style="width:100%;" border="1"> 
            ...
            ?>
                <tr>
                  ...
                  <td colspan="2" align="center"><?=date("d-m-Y",strtotime($row['fecha']));?></td>                	                    
                </tr>
            <? 
                }
            ?> 
