<div id="content-header">
  	<div id="breadcrumb"> 
  		<a href="<?=$mod_root;?>" class="current">Suscripciónes parque inglés</a> 
  	</div>
  	<h1>Reserva tu hogar Parque Inglés</h1>
</div>

<?php
    $me             = "index.php?load=mensaje_laReserva";

    $objects 		= Datos("mensaje_2","1 order by id DESC","*");
        ...
        <div class="span12">
          ...
          <div class="widget-box">
              ...
              <div class="widget-content">                    
              		<a href="<?=BASEURL;?>modulos/mensaje_laReserva/export.php" class="btn btn-success" target="_blank">Exportar a Excel</a>
              </div>
