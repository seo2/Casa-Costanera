...
<?php
    $data   = Datos("mensaje_3_2","1 order by id DESC","*");
    
    if(Filas("mensaje_3_2","1 order by id DESC") > 0)
    {
        ...
        <table id="tabla" style="width:100%;" border="1"> 
            <thead>
                <tr class="cabece">
                    ...
                    <th colspan="2">pre-aprobacion</th>
            ...
            ?>
                <tr>
                  ...
                  <td colspan="2" align="center"><?=d($row['aprobacion']);?></td>
