<div id="content-header">
  	<div id="breadcrumb"> 
  		<a href="<?=$mod_root;?>" class="current">solicitudes info Mirador Bahia</a> 
  	</div>
  	<h1>Mirador Bahia</h1>
</div>

<?php
    $me             = "index.php?load=mensajes_bahia";

    $objects 		= Datos("mensajes_bahia","1 order by id DESC","*");
        ...
        <div class="span12">
          ...
          <div class="widget-box">
              ...
              <div class="widget-content">                    
              		<a href="<?=BASEURL;?>modulos/mensajes_bahia/export.php" class="btn btn-success" target="_blank">Exportar a Excel</a>
              </div>
