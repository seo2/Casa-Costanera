...
header("content-disposition: attachment;filename=Personaliza - San Isidro.xls");
    ...
    <table id="tabla" style="width:100%;"> 
        <tr>
            <td align="center" colspan="10" style="width:100%;">
                <h1>EL DEPA QUE QUIERO - Mensajes de Contacto</h1>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="10" style="width:100%;">
...
<?php
    $data   = Datos("contacto","proyecto = '$_GET[p]' order by id DESC","*");
    
    if(Filas("contacto","proyecto = '$_GET[p]' order by id DESC") > 0)
    {
