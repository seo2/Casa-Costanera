<div id="content-header">
  	<div id="breadcrumb"> 
  		<a href="<?=$mod_root;?>" class="current">Edificio Parque Villanueva</a> 
  	</div>
...
<?php
    ...
    $objects 		= Datos("contacto","proyecto = 'villanueva' order by id DESC","*");
    ...
    if(mysql_num_rows($objects) > 0)
    {
        ...
        $objects        = Datos("contacto",
                                "proyecto = 'villanueva' order by id DESC limit ".$paginador['limitInf'].",".$paginador['tamPag'],
                                "*");
    }   
?>
        ...
        <div class="span12">
          ...
          <div class="widget-box">
              ...
              <div class="widget-content">                    
              		<a href="<?=BASEURL;?>modulos/villanueva/export.php" class="btn btn-success" target="_blank">Exportar a Excel</a>
              </div>
