<?php
	...
	if (isset($_POST['modo'])){
		...
		$ruta_new				= "new_vivienda/".$_POST['proyecto'];
		$ruta_mod				= "edit_vivienda";
		$ruta_volver			= "&p=".$_POST['proyecto'];
		...
		switch($_POST["modo"])
		{
			case "nuevo":
					...
					Insertar($tabla,
							 "nombre,imagenes,descripcion,precio,proyecto",
							 "'$_POST[nombre]','$_POST[foto]','$_POST[descripcion]','$_POST[precio]','$_POST[proyecto]'");
