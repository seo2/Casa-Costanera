	...
	<ul>
    	<li <?=(strpos($action,"index") !== false && $modulo == "viviendas" && $_GET['p'] == 'valle Las Pircas')? 'class="active"':'';?>>
    		<a href="<?=BASEURL."index.php?load=".$m['codigo'];?>&p=valle Las Pircas">Valle las Pircas</a>
    	</li>
    	<li <?=(strpos($action,"index") !== false && $modulo == "viviendas" && $_GET['p'] == 'Parque Ingles III')? 'class="active"':'';?>>
    		<a href="<?=BASEURL."index.php?load=".$m['codigo'];?>&p=Parque Ingles III">Parque ingles III</a>
    	</li>
    	<li <?=(strpos($action,"index") !== false && $modulo == "viviendas" && $_GET['p'] == 'Parque Ingles IV')? 'class="active"':'';?>>
